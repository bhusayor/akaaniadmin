/* ═══════════════════════════════════════════════════════
   ...
   Maps a free-text ingredient name onto a FAO/INFOODS WAFCT 2019
   food record so its per-100g macros can be suggested.

   Loaded by both the single-ingredient form and the CSV importer —
   there is exactly one copy of this logic.

   Runs unmodified in the browser (<script>) and in Node (tests).
   ═══════════════════════════════════════════════════════ */
...
;(function (global) {
  ...
  function findMatches(ingredientName, dataset) {
    dataset = dataset || global.WAFCT_DATA || [];
  ...
  var api = {
    ...
    mapWafctCategory: mapWafctCategory,
    suggestTaxonomy: suggestTaxonomy,
    inferProductCategory: inferProductCategory,
    ...
    WAFCT_CATEGORY_MAP: WAFCT_CATEGORY_MAP,
